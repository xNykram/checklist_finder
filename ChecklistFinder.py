...
class pdfFrame(wx.Frame):
    def __init__(self):
        ...
        pdfFrame.my_sizer.Add(self.textlabel,0,wx.ALL | wx.CENTER, 5)
        self.listbox = wx.ListBox(self.panel, 0, choices=[],style=wx.LB_SINGLE | wx.LB_NEEDED_SB)
        self.listbox.InsertItems(['Example checklist.pdf'],0)
        pdfFrame.my_sizer.Add(self.listbox,0, wx.ALL | wx.CENTER)
        self.btnref = wx.Button(self.panel, label="Refresh")
        self.btnref.Bind(wx.EVT_BUTTON, self.on_refresh_btn)
        pdfFrame.my_sizer.Add(self.btnref,0,wx.ALL | wx.CENTER, 5)
        self.btn = wx.Button(self.panel, label="Run")
        self.btn.Bind(wx.EVT_BUTTON, self.runScript)
        pdfFrame.my_sizer.Add(self.btn,0,wx.ALL | wx.CENTER,5)
